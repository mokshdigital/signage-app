...
export default function WorkOrdersV2Page() {
    ...
    // Columns Definition - Updated to link to V2 detail page
    const columns: Column<WorkOrder>[] = [
        {
            ...
            render: (order) => (
                <Link
                    href={`/dashboard/work-orders-v2/${order.id}`}
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Work Orders (Beta)</h1>
                    <p className="text-sm text-gray-500 mt-1">New tabbed detail view - click on a WO to try it</p>
                </div>
